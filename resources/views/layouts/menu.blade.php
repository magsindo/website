  ...
  <![endif]-->
    ...
    <header class="header-area">
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center"
            style="background-image: url({{asset('assets/images/header-hero.jpg')}})}}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s"
                data-wow-delay="1.1s">
                <div class="image">
                    <img src="{{asset('assets/images/hero-image.jpg')}}" alt="Hero Image">
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-9">
                    <div class="section-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <h4 class="title">Layanan Magsindo <span>untuk anda!</span></h4>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
